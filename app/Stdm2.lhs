...
(version of April 2000, by Cordelia Hall and John O'Donnell
 corrections and extensions by Pierre Lemaire, ENSIMAG
 -- see 'extension2.readme' for details)
...
>   do filedata <- (readFile filename) `catch` (\(e :: IOException) -> return "")
